...
abstract class AbstractSource implements MetadataInterface
{
    ...
    public function getTable($tableName, $schema = null)
    {
        ...
        switch ($data['table_type']) {
            case 'BASE TABLE':
                ...
                break;
            case 'VIEW':
                $table = new Zend\Db\Metadata\Object\ViewObject($tableName);
    ...
    public function getColumn($columnName, $table, $schema = null)
    {
        ...
        $column = new \Zend\Db\Metadata\Object\ColumnObject($columnName, $table, $schema);
        $props = [
    ...
    public function getConstraint($constraintName, $table, $schema = null)
    {
        ...
        $constraint = new \Zend\Db\Metadata\Object\ConstraintObject($constraintName, $table, $schema);
