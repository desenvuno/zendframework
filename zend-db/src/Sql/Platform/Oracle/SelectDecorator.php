...
class SelectDecorator extends Select implements PlatformDecoratorInterface
{
    ...
    protected function processLimitOffset(
        ...
        //Problem with quantifier and limiter
        if($selectParameters[0] == self::QUANTIFIER_ALL || $selectParameters[0] == self::QUANTIFIER_DISTINCT){
            unset($selectParameters[0]);
            //adjusts the indices of the array
            $selectParameters  = array_merge($selectParameters, []);
        }
